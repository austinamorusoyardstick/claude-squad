...
func (m PRReviewModel) simpleView() string {
	...
	b.WriteString("\n")
	b.WriteString(helpStyle.Render("Keys: j/k:nav • a/d:accept/deny • e:expand • s:split • f:toggle filter • c:toggle comments • r:toggle reviews • Enter:process • q:cancel"))
